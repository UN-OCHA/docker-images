...
pushd alpine-base-php/php7 && \
  ...
  docker tag unocha/base-php:${VERSION}${EXTRAVERSION} unocha/base-php:7.4-develop && \
  popd
...
pushd alpine-base-php/php7-newrelic && \
  ...
  docker tag unocha/base-php:${VERSION}-NR${EXTRAVERSION} unocha/base-php:7.4-NR-develop && \
  popd
...
pushd alpine-php/php7 && \
  ...
  docker tag unocha/php:${VERSION}${EXTRAVERSION} unocha/php:7.4-develop && \
  docker tag unocha/php:${VERSION}${EXTRAVERSION} public.ecr.aws/unocha/php:${VERSION}${EXTRAVERSION} && \
  docker tag unocha/php:${VERSION}${EXTRAVERSION} public.ecr.aws/unocha/php:7.4-develop && \
  popd
...
pushd alpine-php/php7 && \
  ...
  docker tag unocha/php:${VERSION}-NR${EXTRAVERSION} unocha/php:7.4-NR-develop && \
  docker tag unocha/php:${VERSION}-NR${EXTRAVERSION} public.ecr.aws/unocha/php:${VERSION}-NR${EXTRAVERSION} && \
  docker tag unocha/php:${VERSION}-NR${EXTRAVERSION} public.ecr.aws/unocha/php:7.4-NR-develop && \
  popd

# Build the k8s php 7 image.
pushd alpine-php/php-k8s-v7 && \
  make VERSION=${VERSION} EXTRAVERSION=${EXTRAVERSION} UPSTREAM=${VERSION}${EXTRAVERSION} build && \
  docker tag unocha/base-php:${VERSION}${EXTRAVERSION} unocha/php-k8s:7.4-develop && \
  docker tag unocha/base-php:${VERSION}${EXTRAVERSION} public.ecr.aws/unocha/php-k8s:${VERSION}${EXTRAVERSION} && \
  docker tag unocha/base-php:${VERSION}${EXTRAVERSION} public.ecr.aws/unocha/php-k8s:7.4-develop && \
  popd

# Build the k8s php 7 image with New Relic.
pushd alpine-php/php-k8s-v7 && \
  make VERSION=${VERSION} EXTRAVERSION=-NR${EXTRAVERSION} UPSTREAM=${VERSION}-NR${EXTRAVERSION} build && \
  docker tag unocha/php-k8s:${VERSION}-NR${EXTRAVERSION} unocha/php-k8s:7.4-NR-develop && \
  docker tag unocha/php-k8s:${VERSION}-NR${EXTRAVERSION} public.ecr.aws/unocha/php-k8s:${VERSION}-NR${EXTRAVERSION} && \
  docker tag unocha/php-k8s:${VERSION}-NR${EXTRAVERSION} public.ecr.aws/unocha/php-k8s:7.4-NR-develop && \
  popd
...
pushd alpine-base-php/php8 && \
  ...
  docker tag unocha/base-php:${VERSION8}${EXTRAVERSION} unocha/base-php:8.0-develop && \
  popd
...
pushd alpine-base-php/php8-newrelic && \
  ...
  docker tag unocha/base-php:${VERSION8}-NR${EXTRAVERSION} unocha/base-php:8.0-NR-develop && \
  popd
...
pushd alpine-php/php8 && \
  ...
  docker tag unocha/php:${VERSION8}${EXTRAVERSION} unocha/php:8.0-develop && \
  docker tag unocha/php:${VERSION8}${EXTRAVERSION} public.ecr.aws/unocha/php:${VERSION8}${EXTRAVERSION} && \
  docker tag unocha/php:${VERSION8}${EXTRAVERSION} public.ecr.aws/unocha/php:8.0-develop && \
  popd
...
pushd alpine-php/php8 && \
  ...
  docker tag unocha/php:${VERSION8}-NR${EXTRAVERSION} unocha/php:8.0-NR-develop && \
  docker tag unocha/php:${VERSION8}-NR${EXTRAVERSION} public.ecr.aws/unocha/php:${VERSION8}-NR${EXTRAVERSION} && \
  docker tag unocha/php:${VERSION8}-NR${EXTRAVERSION} public.ecr.aws/unocha/php:8.0-NR-develop && \
  popd

# Build the k8s php 8 image.
pushd alpine-php/php-k8s-v8 && \
  make VERSION=${VERSION8} EXTRAVERSION=${EXTRAVERSION} UPSTREAM=${VERSION8}${EXTRAVERSION} build && \
  docker tag unocha/base-php:${VERSION8}${EXTRAVERSION} unocha/php-k8s:8.0-develop && \
  docker tag unocha/base-php:${VERSION8}${EXTRAVERSION} public.ecr.aws/unocha/php-k8s:${VERSION8}${EXTRAVERSION} && \
  docker tag unocha/base-php:${VERSION8}${EXTRAVERSION} public.ecr.aws/unocha/php-k8s:8.0-develop && \
  popd

# Build the k8s php 8 image with New Relic.
pushd alpine-php/php-k8s-v8 && \
  make VERSION=${VERSION8} EXTRAVERSION=-NR${EXTRAVERSION} UPSTREAM=${VERSION8}-NR${EXTRAVERSION} build && \
  docker tag unocha/php-k8s:${VERSION8}-NR${EXTRAVERSION} unocha/php-k8s:8.0-NR-develop && \
  docker tag unocha/php-k8s:${VERSION8}-NR${EXTRAVERSION} public.ecr.aws/unocha/php-k8s:${VERSION8}-NR${EXTRAVERSION} && \
  docker tag unocha/php-k8s:${VERSION8}-NR${EXTRAVERSION} public.ecr.aws/unocha/php-k8s:8.0-NR-develop && \
  popd
